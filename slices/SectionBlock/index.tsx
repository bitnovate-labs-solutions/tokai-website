          ...
          {isPairCards ? (
            isScopeDrawerGrid ? (
              ...
              <motion.div
                ...
                variants={pairCardsContainerVariants}
                initial="hidden"
                whileInView="show"
                ...
                {pairCardItems.map((item, idx) => {
                  ...
                  return (
                    <motion.div
                      ...
                      variants={pairCardsItemVariants}
                      whileHover={{
                        y: -8,
                        transition: { type: "spring", stiffness: 320, damping: 22 },
                      }}
                      className="group relative h-full overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-[0_18px_50px_-26px_rgba(0,0,0,0.35)] ring-1 ring-zinc-950/[0.04]"
                    >
