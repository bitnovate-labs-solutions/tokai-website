...
export default function CompanyEventsHero({ slice }: SliceComponentProps) {
  ...
  return (
    <section className="relative min-h-[min(88vh,920px)] overflow-hidden bg-zinc-950 text-white">
      ...
      <div className="relative z-10 mx-auto flex min-h-[min(88vh,920px)] max-w-[1400px] flex-col justify-end px-4 pb-20 pt-36 md:px-8 md:pb-28 md:pt-32">
        ...
        <motion.div
          ...
          className="mt-16 hidden h-px w-32 rounded-full bg-gradient-to-r from-amber-400/80 to-transparent md:block"
          aria-hidden
        />
      </div>
    </section>
